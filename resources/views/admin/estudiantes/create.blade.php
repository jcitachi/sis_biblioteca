                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="codigo" id="codigo"
                                    ...
                                    value="{{ old('codigo') }}" placeholder="Ej: EST001" required>
                            </div>
                            @error('codigo')
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="dni" id="dni"
                                class="form-control rounded-pill"
                                value="{{ old('dni') }}" placeholder="Ej: 87654321" required>
                            @error('dni')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="apellidos" id="apellidos"
                                class="form-control rounded-pill"
                                value="{{ old('apellidos') }}" placeholder="Ej: Pérez García" required>
                            @error('apellidos')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row justify-content-center mt-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="carrera" id="carrera"
                                class="form-control rounded-pill"
                                value="{{ old('carrera') }}" placeholder="Ej: Ingeniería de Sistemas" required>
                            @error('carrera')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="direccion" id="direccion"
                                class="form-control rounded-pill"
                                value="{{ old('direccion') }}" placeholder="Ingrese una dirección válida" required>
                            @error('direccion')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="telefono" id="telefono"
                                class="form-control rounded-pill"
                                value="{{ old('telefono') }}" placeholder="Ej: 987654321" required>
                            @error('telefono')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
